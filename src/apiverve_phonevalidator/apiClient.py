...
class PhonenumbervalidatorAPIClient:
    def __init__(self, api_key, secure=True):
        """
        Initialize the PhonenumbervalidatorAPIClient with the API key and secure flag
        ...
        self.secure = secure
        self.base_url = 'https://api.apiverve.com/v1.0.9/phonenumbervalidator'
        self.headers = {
